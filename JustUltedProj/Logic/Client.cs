...
using JustUltedProj.Logic.Replays;
...
namespace JustUltedProj.Logic
{
    ...
    internal static class Client
    {
        ...
        /// </summary>
        internal static string Version = "4.21.5";
        ...
        internal static void SwitchPage(Page page)
        {
            ...
            if (page.GetType() == typeof(ChampSelectPage) || page.GetType() == typeof(LoginPage)) BackgroundImage.Visibility = Visibility.Hidden;
